        <!-- Main Content -->
          ...
          <div class="row">
            <div class="col-md-12">
                  <a  data-toggle="modal" href="#myModal" class="pull-right btn-sm btn btn-default">Add Category</a>
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=addcategory">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Short Name</label>
    <div class="col-lg-10">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="is_active"> Active Category
        </label>
      </div>
    </div>
  </div>
...
<?php foreach($categories as $cat):?>
                        <tr>
                        <td style="width:30px;">
                          <a href="../?view=posts&cat=<?php echo $cat->short_name; ?>" target="_blank" class="btn btn-default btn-xs"><i class="fa fa-eye"></i></a>
                        </td>
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=updatecategory">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Name</label>
    <div class="col-lg-10">
      <input type="text" required class="form-control" name="name" value="<?php echo $cat->name;?>" placeholder="Category Name">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Short Name</label>
    <div class="col-lg-10">
      <input type="text" required class="form-control" value="<?php echo $cat->short_name; ?>" name="short_name" placeholder="Short Name">
    </div>
  </div>
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="is_active" <?php if($cat->is_active){ echo "checked"; }?>>  Active Category
        </label>
      </div>
    </div>
  </div>
