        ...
        <div class="col-md-6">
          <form method="post" action="add_user.php">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="full-name" placeholder="Joaquin Salvador Matos" required>
            </div>
            <div class="form-group">
                <label for="username">Username</label>
                <input type="text" class="form-control" name="username" placeholder="mth_fcs">
            </div>
            <div class="form-group">
